...
Gera os 5 documentos de atributos nao funcionais do cliente. Todos sao a projecao no frontend do que ja foi decidido em `/blueprint:blueprint-quality`.
...
Do cliente (ja preenchidos por `/blueprint:frontend-app`): `07-routes.md`, `08-flows.md`, `01-architecture.md`
...
>
> - Outro cliente? Rode `/blueprint:frontend-app {outro-cliente}`
> - Nova feature? Rode `/blueprint:increment`
> - Backlog de tasks? Rode `/blueprint:specs`"
