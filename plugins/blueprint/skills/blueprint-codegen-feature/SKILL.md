---
name: blueprint-codegen-feature
description: Implementa uma feature vertical (DB + API + Frontend + Testes) com TDD/XP.
---
<!-- GERADO por tools/build-codex.py a partir de skills/codegen-feature/SKILL.md.
...
- `blueprint-codegen-setup` executado (AGENTS.md, tipos e schema existem)
...
**NAO carregue todos os blueprints.** Leia AGENTS.md e `docs/shared/MAPPING.md` para identificar docs relevantes.
...
> "Para proxima feature: `blueprint-codegen-feature [nome]`. Para verificar: `blueprint-codegen-verify`."
