...
---
<!-- GERADO por tools/build-codex.py a partir de skills/frontend-app/SKILL.md.
...
> "Aplicacao documentada para {client} (00, 01, 02, 04, 05, 07, 08, 14). Rode `blueprint-frontend-quality {client}` para testes, performance, seguranca, observabilidade e CI/CD."
