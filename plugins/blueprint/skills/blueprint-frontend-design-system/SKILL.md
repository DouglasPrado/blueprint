---
name: blueprint-frontend-design-system
description: Gera o design system compartilhado (shared/03-design-system.md) — tokens, tipografia, cores e iconografia.
---
<!-- GERADO por tools/build-codex.py a partir de skills/frontend-design-system/SKILL.md.
...
> "Design System definido (compartilhado entre todos os clientes). Rode `blueprint-frontend-app {client}` para documentar a aplicacao do cliente desejado."
