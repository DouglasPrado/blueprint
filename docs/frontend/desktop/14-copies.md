...
| Suporte i18n | {{Sim — lib: react-intl / i18next / Nao}} |
...
> Quais sao os textos de cada tela? Organize por janela/rota conforme definido em 07-rotas.md.
...
| Chave i18n | Texto | Onde aparece |
| --- | --- | --- |
| {{feedback.warning.unsavedChanges}} | {{Voce tem alteracoes nao salvas. Deseja sair?}} | {{Modal ao navegar/fechar janela}} |
...
| --- | --- | --- |
| {{Titulo da janela}} | {{global.titlebar.appName}} | {{{{NomeProduto}}}} |
| {{Tooltip minimizar}} | {{global.titlebar.minimize}} | {{Minimizar}} |
| {{Tooltip maximizar}} | {{global.titlebar.maximize}} | {{Maximizar}} |
| {{Tooltip fechar}} | {{global.titlebar.close}} | {{Fechar}} |

<!-- APPEND:copies-titlebar -->

### Menu Bar

| Menu | Elemento | Chave i18n | Texto Padrao |
| --- | --- | --- | --- |
| File | {{Novo}} | {{global.menu.file.new}} | {{Novo}} |
| File | {{Abrir}} | {{global.menu.file.open}} | {{Abrir...}} |
| File | {{Salvar}} | {{global.menu.file.save}} | {{Salvar}} |
| File | {{Salvar como}} | {{global.menu.file.saveAs}} | {{Salvar como...}} |
| File | {{Sair}} | {{global.menu.file.quit}} | {{Sair}} |
| Edit | {{Desfazer}} | {{global.menu.edit.undo}} | {{Desfazer}} |
| Edit | {{Refazer}} | {{global.menu.edit.redo}} | {{Refazer}} |
| Edit | {{Recortar}} | {{global.menu.edit.cut}} | {{Recortar}} |
| Edit | {{Copiar}} | {{global.menu.edit.copy}} | {{Copiar}} |
| Edit | {{Colar}} | {{global.menu.edit.paste}} | {{Colar}} |
| View | {{Aumentar zoom}} | {{global.menu.view.zoomIn}} | {{Aumentar zoom}} |
| View | {{Diminuir zoom}} | {{global.menu.view.zoomOut}} | {{Diminuir zoom}} |
| View | {{Tela cheia}} | {{global.menu.view.fullscreen}} | {{Tela cheia}} |
| Help | {{Documentacao}} | {{global.menu.help.docs}} | {{Documentacao}} |
| Help | {{Verificar atualizacoes}} | {{global.menu.help.checkUpdates}} | {{Verificar atualizacoes...}} |
| Help | {{Sobre}} | {{global.menu.help.about}} | {{Sobre {{NomeProduto}}}} |
...
| Elemento | Chave i18n | Texto Padrao |
| --- | --- | --- |
| {{Tooltip}} | {{global.tray.tooltip}} | {{{{NomeProduto}} — Conectado}} |
| {{Abrir}} | {{global.tray.open}} | {{Abrir {{NomeProduto}}}} |
...
| Evento | Chave i18n titulo | Texto titulo | Chave i18n corpo | Texto corpo |
| --- | --- | --- | --- | --- |
| Update disponivel | {{notification.update.title}} | {{Atualizacao disponivel}} | {{notification.update.body}} | {{Versao {{version}} esta pronta para instalar.}} |
| Download concluido | {{notification.download.title}} | {{Download concluido}} | {{notification.download.body}} | {{O arquivo "{{filename}}" foi baixado com sucesso.}} |
| {{Outro evento}} | {{notification.event.title}} | {{Titulo}} | {{notification.event.body}} | {{Corpo}} |
...
| Dialogo | Chave i18n titulo | Texto titulo | Chave i18n botao | Texto botao |
| --- | --- | --- | --- | --- |
| Abrir arquivo | {{dialog.open.title}} | {{Selecionar arquivo}} | {{dialog.open.button}} | {{Abrir}} |
| Salvar arquivo | {{dialog.save.title}} | {{Salvar arquivo}} | {{dialog.save.button}} | {{Salvar}} |
| Confirmar saida | {{dialog.quit.title}} | {{Sair da aplicacao?}} | {{dialog.quit.confirm}} | {{Sair}} |
| Confirmar exclusao | {{dialog.delete.title}} | {{Confirmar exclusao}} | {{dialog.delete.confirm}} | {{Excluir}} |
...
| Menu items sem reticencias (exceto dialogo) | Salvar | Salvar... |
| Reticencias indicam abertura de dialogo | Abrir... | Abrir |
