---
name: blueprint-codegen-verify
description: Verifica aderencia do codigo ao blueprint — tipos, endpoints, fluxos e regras.
---
<!-- GERADO por tools/build-codex.py a partir de skills/codegen-verify/SKILL.md.
...
Carregue apenas os docs relevantes para a feature (mesmo mapeamento do `blueprint-codegen-feature`). Consulte `docs/shared/MAPPING.md` para rastreabilidade.
...
- Codigo errado → `blueprint-codegen-feature`
- Doc desatualizado → `blueprint-increment`
- Ambiguo → pergunte ao dev

> "Score: {{N}}%. Corrigir: codigo → `blueprint-codegen-feature`, docs → `blueprint-increment`. Continuar: `blueprint-codegen`."
