---
name: frontend-flows
description: Preenche a secao de Fluxos de Interface (08-flows.md) do frontend blueprint a partir do PRD.
---

# Frontend Blueprint — Fluxos de Interface

Preenche `docs/frontend/08-flows.md` com base no PRD e no contexto do projeto.

## Leitura de Contexto

1. Leia `docs/prd.md` — fonte primaria
2. Leia `docs/frontend/08-flows.md` — template a preencher
