...
---
<!-- GERADO por tools/build-codex.py a partir de skills/pipeline/SKILL.md.
...
| 13 | `codegen-setup` | `{projeto-alvo}` | AGENTS.md, `src/contracts/`, schema, scaffold |
...
| 16 | `codegen-setup` | `{projeto-alvo}` | AGENTS.md, `src/contracts/`, schema, scaffold |
