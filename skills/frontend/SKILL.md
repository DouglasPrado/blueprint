...
> 1. Rodar `/blueprint:blueprint` para preencher o blueprint tecnico primeiro
> 2. Passar o caminho do PRD como fallback: `/blueprint:frontend docs/prd.md`
>
> Como prefere?"
...
```
docs/frontend/
  shared/                     # esta skill + /blueprint:frontend-design-system
    03-design-system.md
    06-data-layer.md
    15-api-dependencies.md

  {client}/                   # /blueprint:frontend-app + /blueprint:frontend-quality, por cliente
...
1. /blueprint:frontend                  → 06-data-layer, 15-api-dependencies  [feito nesta sessao]
2. /blueprint:frontend-design-system    → 03-design-system

POR CLIENTE (rodar para cada cliente selecionado):
3. /blueprint:frontend-app {client}     → 00, 01, 02, 04, 05, 07, 08, 14
4. /blueprint:frontend-quality {client} → 09, 10, 11, 12, 13
```

**Recomendacao:** termine todos os docs de um cliente antes de passar ao proximo.

> "Docs compartilhados de dados prontos. Rode `/blueprint:frontend-design-system` para definir tokens, tipografia, cores e iconografia — depois `/blueprint:frontend-app web` (ou o cliente que preferir)."
