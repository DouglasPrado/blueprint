...
description: Preenche a secao de Rotas (07-routes.md) do frontend blueprint a partir do PRD.
---

# Frontend Blueprint — Rotas

Preenche `docs/frontend/07-routes.md` com base no PRD e no contexto do projeto.

## Leitura de Contexto

1. Leia `docs/prd.md` — fonte primaria
2. Leia `docs/frontend/07-routes.md` — template a preencher
