...
---
<!-- GERADO por tools/build-codex.py a partir de skills/shared/SKILL.md.
...
|---|---|
| `docs/blueprint/04-domain-model.md` preenchido | "O glossario deriva do modelo de dominio. Rode `blueprint-domain` primeiro." **pare** |
