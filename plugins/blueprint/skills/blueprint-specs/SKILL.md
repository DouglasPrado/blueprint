---
name: blueprint-specs
description: Gera specs de todas as tarefas de implementacao a partir dos 3 blueprints.
---
<!-- GERADO por tools/build-codex.py a partir de skills/specs/SKILL.md.
...
1. `docs/backend/03-domain.md` com placeholders → "Rode `blueprint-backend` primeiro." (pare)
...
> "Para implementar: `blueprint-codegen-feature [nome]`. Para verificar: `blueprint-codegen-verify`."
